...
public class UserController {
    ...
    /**
     * This Controller method is check whether the username is available on the DB or not
     * @param username
    ...
    public String register(@ModelAttribute("userDetailsRegister") UserDetails userDetails, HttpServletRequest request, HttpServletResponse response, Model model) {
        try {
