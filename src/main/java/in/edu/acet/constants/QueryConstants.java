...
public class QueryConstants {
    ...
    public static final String LOGIN_QUERY = new StringBuilder("SELECT username, password")
    ...
    public static final String REGISTER_QUERY = new StringBuilder("INSERT INTO userdetails(")
            .append(" username, password, dateofbirth, firstname, lastname, gender, ")
            .append("fathername, address, nationality, religion, hscgroup, expobthscmark, ")
            .append("bloodgroup, email, phnumber, expecteddept, isadmin,ultimateadmin)")
            .append(" VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);").toString();

    public static final String GET_ALL_STUDENT = new StringBuilder("SELECT username, dateofbirth, firstname, lastname, gender, ")
            .append("fathername, address, nationality, religion, hscgroup, expobthscmark, ")
            .append("bloodgroup, email, phnumber, expecteddept, isadmin, isattended, ultimateadmin")
            .append(" FROM userdetails WHERE isadmin=false AND ultimateadmin=false;").toString();
    ...
    public static final String GET_TEST_HISTORY_QUERY = new StringBuilder("SELECT t1.username, t1.dateofbirth, t1.firstname, t1.lastname, t1.gender, ")
    ...
    public static final String GET_TEST_HISTORY_QUERY_USER = new StringBuilder("SELECT username, attendeddate, resultdept, reportfilename ")
            .append("FROM user_test_history ")
    ...
    public static final String CHECK_USER_QUERY=new StringBuilder("SELECT username, dateofbirth, firstname, lastname, gender, ")
            .append("fathername, address, nationality, religion, hscgroup, expobthscmark, ")
            .append("bloodgroup, email, phnumber, expecteddept, isadmin,isattended, ultimateadmin")
            .append(" FROM userdetails WHERE username=?;").toString();
